<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://images4.alphacoders.com/863/thumb-1920-863601.png"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff12.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/tZGcu6AyTiI?start=344"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/25M5rVtrWYI"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff12.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(11, 12);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff12/getAllCharacters");
  },
};
</script>
