<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://cache-eu.finalfantasy.com/assets/web/title/bg_ff5-7af9409959e9ccf9ce3e564417acee0fcdd47d1c1bcf2c87015b354994e16c17.jpg"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff5.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/6nMRa-3Ww_c"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/YVj4a49UEDM?start=25"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff5.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(4, 5);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff5/getAllCharacters");
  },
};
</script>
