<template>
  <v-app>
    <Navbar></Navbar>
    <v-main>
      <v-parallax height="100%" src="https://wallpapercave.com/wp/ZDsXFG1.jpg">
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff7.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/JujtlsiqZ-E?start=45"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/xOA5GwRcBks?start=130"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff7.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(6, 7);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff7/getAllCharacters");
  },
};
</script>
