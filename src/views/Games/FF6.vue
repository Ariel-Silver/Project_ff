<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://cache-eu.finalfantasy.com/assets/web/title/bg_ff6_en-bbba7efc490b65d590316d5c1d84126c270ed0b1643e6c05a48155f9523c07b9.png"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff6.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/RDMWp1oLoA0?start=36"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/TP_g13yKLbE"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff6.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(5, 6);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff6/getAllCharacters");
  },
};
</script>
