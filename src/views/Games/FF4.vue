<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://cache-eu.finalfantasy.com/assets/web/title/bg_ff4_en-25927987725e422977904da6e5fb84b0ebb5292073b22b051cf8cac1e47c17f0.png"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff4.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/Njl7aBS0Ah4"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/ss4jCXhiopw"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff4.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(3, 4);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff4/getAllCharacters");
  },
};
</script>
