<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://cache-eu.finalfantasy.com/assets/web/title/bg_ff8-42ef37729e3bd4e0a104b50237561110a56c789b4dd6030d59ef3b9ec66826a7.jpg"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff8.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/XyBensMp_MA"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/MtMGzG_91fY"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff8.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(7, 8);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff8/getAllCharacters");
  },
};
</script>
