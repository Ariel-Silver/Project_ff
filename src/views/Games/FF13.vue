<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://wallpapercave.com/wp/wp2967435.jpg"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff13.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/_WFPiHl_Wdc?start=75"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/_vVW9MJYZLc"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff13.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(12, 13);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff13/getAllCharacters");
  },
};
</script>
