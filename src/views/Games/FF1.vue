<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://cache-eu.finalfantasy.com/assets/web/title/bg_ff_en-09fdc44c8edffbfae9f070c307f268671b2c4b6207a31a42d4b4712b93c8ac82.png"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff1.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/u3pzRgtYDmo?start=11"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/PYDTBvfvjjs?start=800"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff1.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(0, 1);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff1/getAllCharacters");
  },
};
</script>
