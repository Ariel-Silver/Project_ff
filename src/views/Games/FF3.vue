<template>
  <v-app>
    ...
    <v-main>
      <v-parallax
        height="100%"
        src="https://cache-eu.finalfantasy.com/assets/web/title/bg_ff3-ed2dd18221f78521287c36af6637bba6fd94c9c4a1af81e1785f96014e6486b9.jpg"
      >
        <v-row>
          ...
          <div class="divider mt-15">
            ...
            <v-row>
              <v-col
                ...
                md="6"
                lg="4"
                v-for="(character, id) in $store.state.ff3.characters"
                :key="id"
              >
            ...
            <v-layout>
              <v-flex>
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/2rsRnRsDeA4?start=776"
                ...
                <iframe
                  ...
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/emgab2q4_gg?start=776"
                  title="YouTube video player"
                  frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowfullscreen
...
export default {
  ...
  data: () => ({
    show: false,
    file: "https://cache-jp.finalfantasy.com/titles/audio/ff3.mp3",
  }),

  computed: {
    games() {
      return this.$store.state.gamesFilter.slice(2, 3);
    },
  },
  mounted() {
    this.$store.dispatch("getGames");
    this.$store.dispatch("ff3/getAllCharacters");
  },
};
</script>
